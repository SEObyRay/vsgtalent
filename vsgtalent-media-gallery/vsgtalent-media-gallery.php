<?php
/**
 * Plugin Name: VSGTalent Media Gallery
 * Plugin URI: https://vsgtalent.nl
 * Description: Media Gallery manager voor WordPress posts en pagina's
 * Version: 1.8.0
 * Author: Ray Gritter
 * Text Domain: vsgtalent-media-gallery
 */
...
class VSGTalent_Media_Gallery {
    ...
    public function enqueue_gutenberg_assets() {
        // Controleer of we op een post edit pagina zijn
        ...
        wp_add_inline_script('wp-edit-post', 'console.log("VSGTalent: Gutenberg editor gedetecteerd");');
        
        // Sidebar script laden
        wp_enqueue_script(
            'vsgtalent-sidebar',
        ...
        // Debug melding toevoegen
        add_action('admin_notices', function() {
            $screen = get_current_screen();
            if ($screen && $screen->base === 'post') {
                echo '<div class="notice notice-info is-dismissible"><p>VSGTalent Media Galerij: Klik op het instellingen-icoon (tandwiel) rechts bovenin en selecteer "Media Galerij" om afbeeldingen toe te voegen.</p></div>';
            }
        });
    }
    ...
    public function admin_page() {
        ?>
        <div class="wrap">
            <h1>VSGTalent Media Gallery</h1>
            
            <p>VSGTalent Media Gallery plugin is actief.</p>
