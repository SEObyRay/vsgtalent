 ...
 * Description: Automatische configuratie voor VSGTalent backend (nieuwste bugfix versie 6 Nov)
 * Version: 1.8.0
 * Author: Ray Gritter
...
class VSGTalent_Setup_Fixed {
    ...
    public function enqueue_gutenberg_assets() {
        ...
        // Beide scripts laden voor maximale compatibiliteit
        wp_enqueue_script(
            ...
            '1.8.0.' . time(), // Zelfde versie als plugin
            true
        );
        
        // Extra robuuste sidebar script laden
        wp_enqueue_script(
            'vsgtalent-sidebar',
